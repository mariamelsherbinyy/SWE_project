...
def signup():
    ...
    try:
        ...
        login_session['email'] = new_user.email
        login_session['user_id'] = new_user.id
        flash(f"Account created successfully! Welcome, {new_user.name}.")
        return redirect(url_for('showArtists'))
...
def logout():
    ...
    # Handle logout for different providers
    if 'provider' in login_session:
        if login_session['provider'] == 'google':
            gdisconnect()  # Call the Google-specific disconnect function
